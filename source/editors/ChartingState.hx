...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	override function create()
	{
		...
		leftIcon = new HealthIcon('presans');
		rightIcon = new HealthIcon('darkchara');
	...
	{
		if (leftIcon.isAnimated)
			leftIcon.playAnim(leftIcon.getCharacter() + '-normal');
		if (rightIcon.isAnimated)
			rightIcon.playAnim(rightIcon.getCharacter() + '-normal');
	}
	...
	{
		if (CoolUtil.difficulties[0] == null)
